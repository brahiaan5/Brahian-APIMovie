...
namespace API.Movies.Services
{
    public class MovieService : IMovieService
    {
        ...
        public MovieService(IMovieRepository movieRepository, IMapper mapper) =>
            (_movieRepository, _mapper) = (movieRepository, mapper);
        ...
        public async Task<MovieDto?> GetMovieAsync(int movieId) =>
            _mapper.Map<MovieDto>(await _movieRepository.GetMovieAsync(movieId));

        public async Task<ICollection<MovieDto>> GetMoviesAsync() =>
            _mapper.Map<ICollection<MovieDto>>(await _movieRepository.GetMoviesAsync());
